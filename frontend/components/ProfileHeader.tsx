  ...
  return (
    <header className="pt-4 pb-2">
      ...
      <div className="flex items-center justify-between gap-3 mb-4">
        ...
        >
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-primary-600 to-brand-emerald flex items-center justify-center font-bold text-lg text-white shadow-md shrink-0">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Pronto para o treino de hoje? {isExpanded ? '▲' : '▼'}
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="p-2.5 rounded-xl bg-surface-card border border-surface-border text-slate-400 hover:text-rose-400 hover:border-rose-500/30 transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center shrink-0"
        >
      ...
      {isExpanded && (
        <div className="bg-surface-card border border-surface-border rounded-2xl p-4 mb-4 shadow-sm animate-in slide-in-from-top-2 fade-in duration-200">
